...
public class NetworkService extends Service {
	...
	public void onCreate() {
		...
		currentlyRequesting = new ArrayList<NetworkService.NetworkRequest>(
				MAX_NUM_OF_CALLS);
	 ...
	 *            The URL string.
	 * @param headers
	 *            A key-value map for headers.
	 * @param parameters
	 *            A key-value map for parameters.
	 * @param listener
	 *            The NetworkResponseListener that gets called post execution of
	 *            the request.(cannot be null).
	 */
	public void get(String url, Map<String, String> headers,
			Map<String, String> parameters, NetworkResponseListener listener) {
		makeCall(new NetworkRequest(url, headers, parameters, null, listener,
				RequestType.GET));
	}
	 ...
	 *            A key-value map for parameters.
	 * @param content
	 *            The content you want to post/put in the request.
	 * @param listener
	 *            The NetworkResponseListener that gets called post execution of
	 *            the request.(cannot be null).
	 */
	public void post(String url, Map<String, String> headers,
		...
		makeCall(new NetworkRequest(url, headers, parameters, content,
				listener, RequestType.POST));
	}
	 ...
	 *            the request.(cannot be null).
	 */
	public void get(String url, NetworkResponseListener listener) {
		get(url, new HashMap<String, String>(), new HashMap<String, String>(),
				listener);
	}
	 ...
	 *            the request.(cannot be null).
	 */
	public void post(String url, Map<String, String> headers, String content,
			NetworkResponseListener listener) {
		post(url, headers, new HashMap<String, String>(), content.getBytes(),
				listener);
	}
	...
	public void post(String url, String content,
			NetworkResponseListener listener) {
		post(url, new HashMap<String, String>(), new HashMap<String, String>(),
				content.getBytes(), listener);
	}
	 ...
	 *            the request.(cannot be null).
	 */
	public void post(String url, Map<String, String> headers, byte[] content,
			NetworkResponseListener listener) {
	 ...
	 *            the request.(cannot be null).
	 */
	public void post(String url, byte[] content,
			NetworkResponseListener listener) {
		post(url, new HashMap<String, String>(), new HashMap<String, String>(),
				content, listener);
	}
	 ...
	 *            the request.(cannot be null).
	 */
	public void post(String url, NetworkResponseListener listener) {
		post(url, new HashMap<String, String>(), new HashMap<String, String>(),
				new byte[0], listener);
	}
	 ...
	 *            the request.(cannot be null).
	 */
	public void put(String url, Map<String, String> headers, String content,
			NetworkResponseListener listener) {
		put(url, headers, new HashMap<String, String>(), content.getBytes(),
				listener);
	}
	 ...
	 *            the request.(cannot be null).
	 */
	public void put(String url, Map<String, String> headers, byte[] content,
			NetworkResponseListener listener) {
	 ...
	 *            the request.(cannot be null).
	 */
	public void put(String url, String content, NetworkResponseListener listener) {
		put(url, new HashMap<String, String>(), new HashMap<String, String>(),
				content.getBytes(), listener);
	}
	 ...
	 *            the request.(cannot be null).
	 */
	public void put(String url, byte[] content, NetworkResponseListener listener) {
		put(url, new HashMap<String, String>(), new HashMap<String, String>(),
				content, listener);
	}
	 ...
	 *            the request.(cannot be null).
	 */
	public void put(String url, NetworkResponseListener listener) {
		put(url, new HashMap<String, String>(), new HashMap<String, String>(),
				new byte[0], listener);
	}
	 ...
	 *            the request.(cannot be null).
	 */
	public void delete(String url, NetworkResponseListener listener) {
		delete(url, new HashMap<String, String>(),
	...
	private class NetworkRequest extends AsyncTask<Void, Void, Void> {
		...
		private NetworkRequest(String url, Map<String, String> headers,
				Map<String, String> parameters, byte[] content,
				NetworkResponseListener listener, RequestType requestType) {
			...
			try {
				...
				if (responseCode != 200) {
					String reasonPhrase = response.getStatusLine()
							.getReasonPhrase();
					log("Successfully executed request however received bad response : "
							+ responseCode + " - " + reasonPhrase);
	...
	public interface NetworkResponseListener {
		 ...
		 * 
		 * @param data
		 *            The InputStream containing the valid data.
		 */
		public void onSuccess(InputStream data);

		/**
		 * Called when there is an error in making the request or if the call
		 * returns with a bad status code (if it is not status code 200).
		 * 
		 * @param error
		 *            The Exception that contains the error message.
		 */
	 ...
	 *            The connect timeout time in milliseconds.
	 */
	 ...
	 * 
	 * @param debug
	 *            True if you want to see log statements, false otherwise.
	 */
	...
	public void clearCurrentRequests() {
		if (currentlyRequesting != null) {
			for (NetworkRequest request : currentlyRequesting) {
				request.cancel(true);
				request.listener.onError(new Exception(
						"Cancelled request mid execution."));
		...
		if (backlog != null) {
			synchronized (backlog) {
				for (NetworkRequest request : backlog) {
					request.cancel(true);
					request.listener.onError(new Exception(
							"Cancelled request before execution."));
